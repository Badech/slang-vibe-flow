...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SlangFlow — Talk like a native" },
      { name: "description", content: "Learn American idioms, slang & texting language. Sound like a native, not a textbook." },
      { name: "author", content: "SlangFlow" },
      { property: "og:title", content: "SlangFlow — Talk like a native" },
      { property: "og:description", content: "Master American idioms, slang & texting language with audio, examples, and quizzes." },
